         ...
         <div className="p-4 grid grid-cols-3 gap-2">
            {trendyFashion.map((p, idx) => (
               <Link key={idx} href={`/product/${p.id}`} className="flex flex-col gap-1 items-center group">
                  <div className="w-full aspect-square rounded-full border-2 border-primary/20 overflow-hidden relative p-2 bg-slate-50 group-hover:border-primary transition-all">
